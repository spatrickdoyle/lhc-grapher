...
If[
plotrangetmp!="None",
(*20171016 solve "auto" bug*)
If[plotrange[[1]]!="auto",minx=plotrange[[1]] ];
If[plotrange[[2]]!="auto",maxx=plotrange[[2]] ];
If[plotrange[[3]]!="auto",miny=plotrange[[3]] ];
If[plotrange[[4]]!="auto",maxy=plotrange[[4]] ];
"dummy"
];
...
(*20171018 add new PDF sets, no need this function*)
(*
If[
PDFname=="CT14NNLO",
...
(*20171018: new data sets need a new datalis file*)
datalistFile=(*"./dat16lisformathematica";*)"./dat170928lisformathematica";
expttype="multi";
...
(*20171013 boting make test file*)
Export["../plots/testexport.txt","xxx"];
...
(*20171013 boting test making figures*)Print["file name: ",saveparentpath<>jobpath<>filename];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>"testfig.pdf",p3[[1,1]]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>"testfig.eps",p3[[1,1]]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>"testfig.txt",p3[[1,1]]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>"testfig.jpg",p3[[1,1]]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>"testfig2.jpg",Plot[x,{x,0,1}]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>"testfig2.txt",Plot[x,{x,0,1}]];
...
(*20171016 if config file in plot path exist, remove it*)
If[FileExistsQ[saveparentpath <> jobpath <> configfilename] == True, 
  DeleteFile[saveparentpath <> jobpath <> configfilename] ];
